        ...
        NavigationStack {
            VStack(spacing: 20) {
                if !isCompleted {
                    ...
                    VStack(spacing: 8) {
                        HStack {
                            Text("问题 \(currentIndex + 1) / \(quiz.questions.count)")
                                .font(.caption.bold())
                            ...
                            if showResult {
                                VStack(alignment: .leading, spacing: 12) {
                                    HStack {
                                        ...
                                        Text(selectedOption == quiz.questions[currentIndex].answer ? "回答正确" : "回答错误")
                    ...
                    if showResult {
                        Button(action: nextQuestion) {
                            Text(currentIndex + 1 < quiz.questions.count ? "下一题" : "查看结果")
                                .font(.headline)
